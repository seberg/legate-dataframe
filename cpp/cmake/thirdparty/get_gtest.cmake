...
function(find_and_configure_gtest)
  ...
  rapids_cpm_gtest(
    BUILD_EXPORT_SET LegateDataframe-testing-exports
    INSTALL_EXPORT_SET LegateDataframe-testing-exports
  )
  ...
  if(GTest_ADDED)
    ...
    rapids_export_find_package_root(
      BUILD GTest [=[${CMAKE_CURRENT_LIST_DIR}]=] EXPORT_SET LegateDataframe-testing-exports
    )
  endif()
